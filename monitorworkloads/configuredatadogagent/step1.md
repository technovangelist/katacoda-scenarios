...
4.  Then under `.spec.template.metadata.labels` add:
    ...
    The result of these two copy/paste actions should result in something like this: ![metadata and labels indenting](configuredatadogagent/assets/metadatalabelsafter.png)
